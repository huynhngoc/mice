...
if __name__ == '__main__':
    ...
    for x, _ in data_gen:
        ...
        for image in x:
            explanation = explainer.explain_instance(image.astype('double'), model.predict, top_labels=1, hide_color=0, num_samples=1000, segmentation_fn=custom_segmentation)
