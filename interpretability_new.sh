...
do
    singularity exec --nv deoxys.sif python interpretability_new.py $1_$fold.json $PROJECTS/KBT/mice/perf/$2_$fold --temp_folder $SCRATCH_PROJECTS/KBT/perf/$2_$fold --analysis_folder $SCRATCH_PROJECTS/KBT/perf/$2_$fold ${@:3}
done
