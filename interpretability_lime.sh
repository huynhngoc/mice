...
#SBATCH --job-name=mice_lime   # sensible name for the job
...
#SBATCH --output=outputs/lime-%A.out
#SBATCH --error=outputs/lime-%A.out
...
do
    singularity exec --nv deoxys_2025feb.sif python interpretability_lime.py $1_$fold.json $PROJECTS/KBT/mice/perf/$2_$fold --temp_folder $SCRATCH_PROJECTS/KBT/perf/$2_$fold --analysis_folder $SCRATCH_PROJECTS/KBT/perf/$2_$fold ${@:3}
done
